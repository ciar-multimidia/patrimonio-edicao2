...
$(document).ready(function() {
 ...
 // parametros de acessibilidade - mudança de corpo de fonte
  $("#small").click(function(event){
    ...
    $("article h2").animate({"font-size":"20px"});
    $("article h3").animate({"font-size":"18px"});
    $("article h4").animate({"font-size":"15px"});
    $("article p, article ul, article ol").animate({"font-size":"12px", "line-height": "20px"});
    
  });
  
  $("#medium").click(function(event){
    event.preventDefault();
    $("article h2").animate({"font-size":"30px"});
    $("article h3").animate({"font-size":"24px"});
    $("article h4").animate({"font-size":"18px"});
    $("article p, article ul, article ol").animate({"font-size":"15px", "line-height": "26px"});
    
  });
  
  $("#large").click(function(event){
    event.preventDefault();
    $("article h2").animate({"font-size":"36px"});
    $("article h3").animate({"font-size":"30px"});
    $("article h4").animate({"font-size":"21px"});
    $("article p, article ul, article ol").animate({"font-size":"18px", "line-height": "33px"});
